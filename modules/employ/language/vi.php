...
$lang_translator['author'] = 'KennyNguyen (KennyNguyen)';
$lang_translator['createdate'] = '22/09/2016, 13:09';
$lang_translator['copyright'] = '@Copyright (C) 2016 KennyNguyen. All rights reserved';
$lang_translator['info'] = '';
$lang_translator['langtype'] = 'lang_module';

$lang_module['nocatpage'] = 'Lỗi không có chủ đề';

$lang_module['location_list'] = 'Danh sách quê quán';
$lang_module['main'] = 'Trang chính';
$lang_module['config'] = 'Cấu hình';
$lang_module['salary'] = 'Mức lương';
$lang_module['salary_list'] = 'Danh sách mức lương';
$lang_module['age'] = 'Tuổi tác';
$lang_module['age_list'] = 'Danh sách tuổi tác';
$lang_module['job'] = 'Vị trí công việc';
$lang_module['job_list'] = 'Danh sách công việc';
...
$lang_module['content_add'] = 'Thêm người lao động';
...
$lang_module['add_salary_cat'] = 'Thêm Mức lương';
$lang_module['edit_salary_cat'] = 'Sửa Mức lương';
$lang_module['add_age_cat'] = 'Thêm Độ tuổi';
$lang_module['edit_age_cat'] = 'Sửa Độ tuổi';
$lang_module['link'] = 'Website nguồn tin';
$lang_module['cat_sub'] = 'Thuộc chuyên mục';
$lang_module['cat_sub_sl'] = 'Là chuyên mục chính';
$lang_module['note_cat_title'] = 'Chưa có mục công việc';
$lang_module['note_cat_content'] = 'Bạn cần chuyên mục công việc trước khi thêm Người lao động. Hệ thống sẽ chuyển bạn đến trang <strong>Vị trí công việc</strong> trong giây lát!';
...
$lang_module['show_no_image'] = 'Hiển thị ảnh No-Image nếu không bài viết không có hình ảnh';
...
$lang_module['from_salary'] = 'Từ mức lương';
$lang_module['to_salary'] = 'Tới mức lương';
$lang_module['pick_salary'] = 'Chọn mức lương';

$lang_module['from_age'] = 'Từ độ tuổi';
$lang_module['to_age'] = 'Tới độ tuổi';
$lang_module['pick_age'] = 'Chọn độ tuổi';

$lang_module['location_id'] = 'ID';
$lang_module['location_name'] = 'Địa điểm';
$lang_module['location_type'] = 'Loại Địa điểm';
$lang_module['add_location'] = 'Thêm Địa điểm';
$lang_module['edit_location'] = 'Sửa Địa điểm';
$lang_module['pick_location'] = 'Chọn Địa điểm';

$lang_module['add_employee'] = 'Thêm người lao động';

$lang_module['about_family'] = 'Hoàn cảnh gia đình';
$lang_module['about_experience'] = 'Kinh nghiệm';
$lang_module['about_skill'] = 'Kỹ năng';
$lang_module['about_wish'] = 'Mong muốn công việc';
$lang_module['sex'] = 'Giới tính';
$lang_module['male'] = 'Nam';
$lang_module['female'] = 'Nữ';
$lang_module['sex_na'] = 'Khác';
$lang_module['pick_sex'] = 'Chọn giới tính';
$lang_module['religion'] = 'Tôn giáo';
$lang_module['job_status'] = 'Sẵn sàng';
$lang_module['birthday'] = 'Năm sinh';
$lang_module['height'] = 'Chiều cao';
$lang_module['about_weight'] = 'Cân nặng';
$lang_module['about_current_salary'] = 'Mức lương hiện tại';
$lang_module['about_wish_salary'] = 'Mong muốn';

$lang_module['sendmail'] = 'Gửi bài viết qua email';
$lang_module['sendmail_subject'] = 'Bạn nhận được một tin nhắn từ:';
$lang_module['sendmail_subject_contact'] = 'Liên hệ:';
...
$lang_module['sendmail_success_contact'] = 'Yêu cầu của bạn đã gửi thành công. <br  />Chúng tôi sẽ phản hồi trong thời gian sớm nhất. <br  /> Xin cảm ơn !';
...
$lang_module['product_request'] = 'Yêu cầu báo giá';
$lang_module['additional_request'] = 'Yêu cầu chi tiết';
$lang_module['sendmail_phone'] = 'Số điện thoại';
$lang_module['sendmail_ip'] = 'IP khách hàng:';
$lang_module['cus_info'] = 'Thông tin khách hàng';
$lang_module['cus_phone'] = 'Số điện thoại khách hàng:';
$lang_module['cus_company'] = 'Công ty:';
$lang_module['cus_address'] = 'Địa chỉ:';
$lang_module['cus_email'] = 'Email:';
$lang_module['cus_name'] = 'Tên Khách hàng:';
$lang_module['request_welcome2'] = 'Link Khách hàng đã gửi yêu cầu:';
$lang_module['sendmail_address'] = 'Địa chỉ:';
$lang_module['sendmail_company'] = 'Công ty:';
$lang_module['customer_request'] = 'Liên hệ từ khách hàng Web';
$lang_module['captcha'] = 'Mã bảo mật';
$lang_module['search_all'] = 'Tìm tất cả';

$lang_module['main_title'] = 'Tìm kiếm thông tin';
$lang_module['info_title'] = 'Tìm kiếm nâng cao';
...
$lang_module['empty_data_search'] = 'Bạn cần điền từ khóa và chọn ít nhất 1 trường tìm kiếm';
...
$lang_module['search_modul_title'] = 'Trang';
