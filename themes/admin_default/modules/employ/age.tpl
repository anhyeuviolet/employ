			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						&nbsp; <span class="text-middle"><em class="fa fa-refresh fa-lg fa-pointer"onclick="get_alias('age', {aid});">&nbsp;</em></span>
					</td>
				</tr>
				<tr>
					<td class="text-right"><strong>{LANG.from_age}: </strong></td>
					<td><input class="form-control w500" name="from_age" type="text" value="{from_age}" maxlength="255" /></td>
				</tr>
				<tr>
					<td class="text-right"><strong>{LANG.to_age}: </strong></td>
					<td><input class="form-control w500" name="to_age" type="text" value="{to_age}" maxlength="255" /></td>
				</tr>
				<tr>
